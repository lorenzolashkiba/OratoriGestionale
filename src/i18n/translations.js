export const translations = {
  it: {
    ...
    analytics: {
      ...
      subtitle: 'Visite e modifiche dati raccolte automaticamente per capire uso settimanale, andamento mensile e freschezza delle informazioni.',
      backToAdmin: 'Torna ad Admin',
      generatedAt: 'Aggiornato',
      overview: 'Panoramica dati',
      overviewDescription: 'Totali attuali delle collezioni principali.',
      visitorsTitle: 'Visite',
      visitorsDescription: 'Utenti unici, sessioni e pagine più visitate negli ultimi 7 e 30 giorni.',
      weekUniqueUsers: 'Utenti unici 7 giorni',
      weekUniqueUsersHint: 'Persone distinte con almeno una visita',
      weekSessions: 'Sessioni 7 giorni',
      weekSessionsHint: 'Aperture tracciate durante la settimana',
      monthUniqueUsers: 'Utenti unici 30 giorni',
      monthUniqueUsersHint: 'Copertura reale del mese',
      monthPageViews: 'Page view 30 giorni',
      avgDailyUsers: 'Media utenti/giorno',
      weekTrend: 'Trend giornaliero',
      weekTrendHint: 'Utenti unici per giorno negli ultimi 7 giorni',
      usersShort: 'utenti',
      noVisits: 'Nessuna visita tracciata nel periodo selezionato',
      topPages: 'Pagine più viste',
      topPagesHint: 'Classifica ultimi 30 giorni',
      topUsers: 'Utenti più attivi',
      topUsersHint: 'Chi entra più spesso nel gestionale',
      changesTitle: 'Modifiche dati',
      changesDescription: 'Frequenza aggiornamenti e salute delle collezioni principali.',
      changesWeek: 'Modifiche 7 giorni',
      changesWeekHint: 'Create, aggiornamenti, eliminazioni e azioni admin',
      changesMonth: 'Modifiche 30 giorni',
      daysWithChanges: 'Giorni con modifiche',
      avgInterval: 'Ore medie tra modifiche',
      avgIntervalHint: 'Intervallo medio nell’ultimo mese',
      lastVisit: 'Ultima visita registrata',
      lastVisitHint: 'Ultimo accesso rilevato',
      changeTypes: 'Modifiche per area',
      changeTypesHint: 'Dove si concentrano gli aggiornamenti',
      noChanges: 'Nessuna modifica registrata nel periodo selezionato',
      collectionHealth: 'Freschezza dati',
      collectionHealthHint: 'Record totali e record fermi da oltre 180 giorni.',
      totalRecords: 'Record totali',
      staleRecords: 'Da rivedere',
      lastUpdated: 'Ultimo aggiornamento',
      recentChanges: 'Ultime modifiche',
      recentChangesHint: 'Cronologia sintetica delle azioni più recenti.',
      byActor: 'Eseguito da',
      loadError: 'Impossibile caricare la dashboard analytics',
      entities: {
        users: 'Utenti',
        oratori: 'Oratori',
      ...
      actions: {
        ...
        updateProfile: 'Profilo aggiornato',
  ...
  ru: {
    ...
    analytics: {
      ...
      subtitle: 'Автоматическая сводка по посещениям и изменениям данных, чтобы видеть недельную активность, месячную динамику и актуальность информации.',
      backToAdmin: 'Назад в Admin',
      generatedAt: 'Обновлено',
      overview: 'Обзор данных',
      overviewDescription: 'Текущее количество записей в основных коллекциях.',
      visitorsTitle: 'Посещения',
      visitorsDescription: 'Уникальные пользователи, сессии и самые посещаемые страницы за последние 7 и 30 дней.',
      weekUniqueUsers: 'Уникальные за 7 дней',
      weekUniqueUsersHint: 'Разные пользователи хотя бы с одним визитом',
      weekSessions: 'Сессии за 7 дней',
      weekSessionsHint: 'Зафиксированные открытия в течение недели',
      monthUniqueUsers: 'Уникальные за 30 дней',
      monthUniqueUsersHint: 'Реальный охват за месяц',
      monthPageViews: 'Просмотры за 30 дней',
      avgDailyUsers: 'Среднее пользователей/день',
      weekTrend: 'Дневной тренд',
      weekTrendHint: 'Уникальные пользователи по дням за последние 7 дней',
      usersShort: 'польз.',
      noVisits: 'За выбранный период посещения не зафиксированы',
      topPages: 'Самые посещаемые страницы',
      topPagesHint: 'Рейтинг за последние 30 дней',
      topUsers: 'Самые активные пользователи',
      topUsersHint: 'Кто чаще всего заходит в систему',
      changesTitle: 'Изменения данных',
      changesDescription: 'Частота обновлений и состояние основных коллекций.',
      changesWeek: 'Изменения за 7 дней',
      changesWeekHint: 'Создание, обновление, удаление и админ-действия',
      changesMonth: 'Изменения за 30 дней',
      daysWithChanges: 'Дней с изменениями',
      avgInterval: 'Средний интервал, часов',
      avgIntervalHint: 'Среднее время между изменениями за месяц',
      lastVisit: 'Последний визит',
      lastVisitHint: 'Последний зафиксированный вход',
      changeTypes: 'Изменения по разделам',
      changeTypesHint: 'Где сосредоточены обновления',
      noChanges: 'За выбранный период изменений не зарегистрировано',
      collectionHealth: 'Актуальность данных',
      collectionHealthHint: 'Всего записей и записи без обновления более 180 дней.',
      totalRecords: 'Всего записей',
      staleRecords: 'Нужно проверить',
      lastUpdated: 'Последнее обновление',
      recentChanges: 'Последние изменения',
      recentChangesHint: 'Краткая история последних действий.',
      byActor: 'Выполнил',
      loadError: 'Не удалось загрузить analytics dashboard',
      entities: {
        users: 'Пользователи',
        oratori: 'Ораторы',
        congregazioni: 'Собрания',
        programmi: 'Программы',
      },
      routes: {
        home: 'Главная',
      ...
      actions: {
        ...
        updateProfile: 'Профиль обновлён',
        deleteAccount: 'Аккаунт удалён',
