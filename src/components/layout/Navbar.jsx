...
export default function Navbar() {
  ...
  const baseNavLinks = [
    ...
    { path: '/discorsi', labelKey: 'nav.discorsi', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6h6M12 10h6M6 6h.01M6 10h.01M6 14h.01M12 14h6M12 18h6M6 18h.01" />
      </svg>
    )},
    { path: '/guida', labelKey: 'nav.guida', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v13m0-13a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2h5a2 2 0 002-2m0-11a2 2 0 012-2h5a2 2 0 012 2v11a2 2 0 01-2 2h-5a2 2 0 01-2-2" />
      </svg>
    )},
